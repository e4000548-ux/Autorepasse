...
export default function RepasseCard({ v, testid }) {
  ...
  return (
    <Link
      ...
      data-testid={testid}
      className="group flex flex-col bg-white border-2 border-[#F5A623] hover:border-[#E59411] hover:-translate-y-1 hover:shadow-[0_12px_40px_rgba(245,166,35,0.25)] transition-all duration-300"
    >
      <div className="aspect-[4/3] overflow-hidden bg-zinc-100 relative">
        ...
        <div className="absolute top-3 left-3 bg-[#F5A623] text-black text-[10px] font-black uppercase tracking-[0.2em] px-2.5 py-1 inline-flex items-center gap-1">
      ...
      <div className="p-5 flex-1 flex flex-col">
        ...
        <div className="mt-auto pt-5 space-y-2">
          <div className="grid grid-cols-2 gap-2">
            ...
            <div className="border-2 border-[#F5A623] px-3 py-2 bg-[#FFF8EC]">
              <div className="text-[9px] uppercase tracking-widest font-black text-[#8A5F0D]">
                Oferta
              </div>
              <div
          ...
          {hasMargin && (
            <div className="inline-flex items-center gap-1.5 bg-emerald-50 text-emerald-800 text-xs font-bold px-2.5 py-1.5">
              <TrendingUp size={13} />
